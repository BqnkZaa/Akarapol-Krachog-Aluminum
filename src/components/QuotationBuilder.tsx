    ...
    return (
      <div className="max-w-7xl mx-auto p-3 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 print:block print:p-0">
        ...
        <div className="lg:col-span-8 space-y-8 print:w-full">
          ...
          {(result as any).components && (result as any).components.length > 0 && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 break-inside-avoid mb-8 print:shadow-none print:border-gray-300">
              <h3 className="font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-2">รายการชิ้นส่วน (Component Breakdown)</h3>
              <div className="space-y-4">
                {(result as any).components.map((comp: any, idx: number) => (
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 print:shadow-none print:border-gray-300 break-inside-avoid">
                ...
                <div className="space-y-2 mt-3 text-sm text-gray-600">
                  <div className="flex justify-between">
                    <span>ขนาด</span>
                    <span className="font-medium text-gray-900">{(glassDetail.widthPerPanelMm / 10).toFixed(1)} × {(glassDetail.heightPerPanelMm / 10).toFixed(1)} ซม.</span>
                  </div>
                  <div className="flex justify-between">
                    <span>จำนวน</span>
