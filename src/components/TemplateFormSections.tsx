...
export function GlassSection({ glass, glasses, onChange }: GlassSectionProps) {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="p-5 sm:p-6">
        ...
        {glass.enabled && (
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Glass type — dropdown from master data */}
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">
              ...
              {glasses.length > 0 ? (
                <select
                  ...
                  onChange={e => {
                    ...
                    onChange("glassType", selectedName);
                    // Auto-fill price from master data
                    const found = glasses.find(g => g.name === selectedName);
                    if (found) {
                      onChange("pricePerSqM", found.pricePerSqM);
                    }
                  }}
                  className={inp}
                >
