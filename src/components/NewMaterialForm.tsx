...
import { createMaterial } from "@/actions/admin";
...
export default function NewMaterialForm({ categories, colors }: Props) {
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <select
              ...
              className={inputCls}
            >
              <option value="เส้น">เส้น (piece/length)</option>
              <option value="ชิ้น">ชิ้น (piece)</option>
              <option value="ม.">ม. (meter)</option>
              <option value="แผ่น">แผ่น (sheet)</option>
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              placeholder="e.g. เฟรมบน-ล่างบานเลื่อน ไอคอนิค"
              required
              className={inputCls}
            />
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              placeholder="Brief note about this profile, e.g. where it's used..."
              rows={2}
